...
! F-A mp scheme only
      ...
      real(kind=kind_phys), dimension(size(Grid%xlon,1),lm+LTP)   :: qc_save
      real(kind=kind_phys), dimension(size(Grid%xlon,1),lm+LTP)   :: qi_save
      real(kind=kind_phys), dimension(size(Grid%xlon,1),lm+LTP)   :: qs_save 
